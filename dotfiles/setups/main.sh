sh ~/.config/qtile/dotfiles/setups/git.sh
sh ~/.config/qtile/dotfiles/setups/apps.sh
sh ~/.config/qtile/dotfiles/setups/fonts.sh
sh ~/.config/qtile/dotfiles/setups/docker.sh
